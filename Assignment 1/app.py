...
app = Flask(__name__)
line_bot_api = LineBotApi('miOs/+E1v9tfM26rOT1ZKGzQgnI9KycNUjKi5g4ONS/IvThBEgAB/KxtSpPG3zFXi8v5P/CedyP9X0WdxYTqX/tI8+ll4PR3BClZm+WP5QUFbhO1FYFlZCuJVuYIA1nKvdVxXofJ7NEc8IXm/GfQNwdB04t89/1O/w1cDnyilFU=')
line_handler = WebhookHandler('7e457c3493b3b605ba14810f91993890')

url ='https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWA-B15D38E0-15A4-44F9-9914-453F2681BFE2&format=JSON'
ansA=[]
city=''
